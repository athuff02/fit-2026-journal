  ...
  if (deleteBtn) {
    ...
    deleteBtn.onclick = () => {
      if (!confirmDelete) {
          ...
          deleteBtn.className = "bg-red-600 text-white px-3 py-2 rounded text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:ring-offset-2 ml-2";
